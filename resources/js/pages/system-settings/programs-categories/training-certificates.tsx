...
export default function TrainingCertificates() {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        // TODO: Add API call to save training certificate
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Training Certificates" />
            <div className="flex items-center justify-between py-4 px-4">
                ...
                <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                    <DialogTrigger asChild>
                        <Button>Add Training Certificate</Button>
                    </DialogTrigger>
                    <DialogContent className="sm:max-w-[600px]">
                        <DialogHeader>
                            <DialogTitle>Add Training Certificate</DialogTitle>
                            <DialogDescription>
                                Create a new training certificate to organize your programs.
                            </DialogDescription>
                        </DialogHeader>
                            ...
                            <div className="space-y-4 py-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="Enter training certificate name"
                                        required
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        placeholder="Enter training certificate description"
                                        rows={4}
                                    />
                                </div>
                            </div>
