...
export default function TrainingLevels() {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        // TODO: Add API call to save training level
            ...
            <div className="flex items-center justify-between py-4 px-4">
                ...
                <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                    <DialogTrigger asChild>
                        <Button>Add Training Level</Button>
                    </DialogTrigger>
                    <DialogContent className="sm:max-w-[600px]">
                        <DialogHeader>
                            <DialogTitle>Add Training Level</DialogTitle>
                            <DialogDescription>
                                Create a new training level to organize your programs.
                            </DialogDescription>
                        </DialogHeader>
                            ...
                            <div className="space-y-4 py-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        placeholder="Enter training level description"
                                        rows={4}
                                    />
                                </div>
                            </div>
